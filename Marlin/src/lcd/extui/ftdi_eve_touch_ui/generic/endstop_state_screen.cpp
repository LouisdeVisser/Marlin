...
void EndstopStatesScreen::onRedraw(draw_mode_t) {
  ...
  #if USE_Z_MIN
    PIN_ENABLED (1, 4, PSTR(STR_Z_MIN), Z_MIN, Z_MIN_ENDSTOP_HIT_STATE)
		PIN_ENABLED (3, 4, PSTR(STR_Z2_MIN), Z2_MIN, Z_MIN_ENDSTOP_HIT_STATE)
		PIN_ENABLED (5, 4, PSTR(STR_Z3_MIN), Z3_MIN, Z_MIN_ENDSTOP_HIT_STATE)
  #else
