...
SCREEN_TABLE {
  ...
  DECL_SCREEN_IF_INCLUDED(FTDI_STEPPER_BUMP_SENSITIVITY_SCREEN)
	DECL_SCREEN_IF_INCLUDED(FTDI_STEPPER_THRESHOLD_SCREEN)
  ...
  DECL_SCREEN_IF_INCLUDED(COCOA_STATISTICS_SCREEN)
	DECL_SCREEN_IF_INCLUDED(FTDI_SHAPING_SCREEN)
	DECL_SCREEN_IF_INCLUDED(FTDI_TEMPERATURE_PRESET_SCREEN)
};
